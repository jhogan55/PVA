...
namespace PVAfront
{
    class VitalRates
    {
        //Starting vital rates for Santa Rosa Capuchins, as of Feb 2020. THESE NEED RECALCULATING, CURRENTLY JUST DIVIDED OLD RATES BY 12  
        public const double AMRRATE = 0.025; //Annual rate of 30% amr divided by 12 
        public const int RISKPERIOD = 6; //length a risk period lasts for after a takeover (6 months for now)
        public const double SEXRATIO = 0.5; //ratio of males to females at birth. 
        ...
        double afSurvMean = 0.996;
        double afSurvSd = 0.01;
        ...
        double juvSurvMean = 0.996;
        double juvSurvSd = 0.01;
        
        //Infant female survival, mean and sd, during stable and AMR periods 
        double infSurvStbMean = 0.967;
        double infSurvStbSd = 0.0167;
        double infSurvAmrMean = 0.933;
        double infSurvAmrSd = 0.025;
